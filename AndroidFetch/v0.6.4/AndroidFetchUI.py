...
with open('config.txt', 'r') as file:
    ...
    CustomFont = CustomFont.replace(".ttf", "")
    CustomFont = CustomFont.replace("Fonts/", "")
...
class AndroidFetch(App):
    button_title = StringProperty(f"AndroidFetch v0.6.3")
    ...
    def secret_title(self, instance):
        ...
        ButtonPressNum += 1
        if ButtonPressNum > 4:
            self.button_title = "AndroidFetch v0.6.3 - Made by cocobo1 :)"
